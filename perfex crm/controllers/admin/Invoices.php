...
class Invoices extends AdminController
{
    ...
    {
        require_once '/home1/a977794/crmdemo.rebootit.info/application/third_party/google/autoload.php';
        if ($this->input->post()) {
            ...
            if ($id == '') {
                ...
                if ($id) {
                    ...
                    putenv('GOOGLE_APPLICATION_CREDENTIALS=/home1/a977794/crmdemo.rebootit.info/service.json');
                    ...
                    $event = new Google_Service_Calendar_Event(array(
                        'summary' => 'Perfex Event',
                        'description' => 'test',
                        'start' => array(
                          'dateTime' => '2022-06-22T09:00:00-07:00'
                        ),
                        'end' => array(
                          'dateTime' => '2022-06-26T09:00:00-07:00'
                        )
                      ));
                      
                      $calendarId = 'ael2nvm4hgq5r0ubkb25ajr968@group.calendar.google.com';
                      $event = $service->events->insert($calendarId, $event);
                      printf('Event created: %s\n', $event->htmlLink, $data['start']);
